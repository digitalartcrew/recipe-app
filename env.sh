...
export DB_PASSWORD=PA$$word01
export DB_PORT=3306
export MAPBOX_ACCESS_TOKEN=VALUE
export S3_KEY=VALUE
export S3_SECRET=VALUE
export S3_BUCKET=VALUE
export STREAM_APP_ID=13348
export STREAM_KEY=x949ejqnbhs8
export STREAM_SECRET=8ngw5ynxdtk848ksa32td95622f5xcs5wq5c2zkmn3qbec876w3uvjmz2bcya3u2
